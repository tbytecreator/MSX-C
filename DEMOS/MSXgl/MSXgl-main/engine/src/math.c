...
i8 Math_Div10(i8 val) __NAKED __FASTCALL __PRESERVES(a, b, c, iyl, iyh)
{
	val; // L
...
i16 Math_Div10_16b(i16 val) __NAKED __FASTCALL __PRESERVES(b, d, e, iyl, iyh)
{
	val; // HL
...
//				Z	Flag is set if divisible by 10
// 24 bytes,  98cc
u8 Math_Mod10_16b(u16 val) __NAKED __FASTCALL __PRESERVES(b, c, d, e, iyl, iyh)
{
	val; // HL
...
i16 Math_Negative16(i16 val) __NAKED __FASTCALL __PRESERVES(b, c, d, e, iyl, iyh)
{
	val; // HL
...
{
__asm
_Math_SignedDiv64:: // val -> A
	sra		a
_Math_SignedDiv32:: // val -> A
	sra		a
_Math_SignedDiv16:: // val -> A
	sra		a
_Math_SignedDiv8:: // val -> A
	sra		a
_Math_SignedDiv4:: // val -> A
	sra		a
_Math_SignedDiv2:: // val -> A
	sra		a
